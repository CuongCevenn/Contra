...
void ThreatsObject::CheckToMap(Map& map_data)
{
    ...
    if(x1 >= 0 && x2 < MAX_MAP_X && y1 >= 0 && y2 <= MAX_MAP_Y)
    {
        if(x_val_ > 0) // main object is moving to right
        {
            ...
            if(val1 != BLANK_TILE && val1 != STATE_MONEY && val1 != CHECK_POINT && val1 != 18 && val1 != 19 && val1 != 20|| val2 != BLANK_TILE && val2 != STATE_MONEY && val2 != CHECK_POINT && val2 != 18 && val2 != 19 && val2 != 20)
            {
                x_pos_ = x2*TILE_SIZE;
    ...
    else
    {
        if(on_ground_ == true)
        {
            if(x_pos_ > animation_b_)
            {
                ...
                loadImage("asset/img/threat_left.png", screen);
            }
            else if(x_pos_ < animation_a_)
            {
                input_type_.left_ = 0;
                input_type_.right_ = 1;
                loadImage("asset/img/threat_right.png", screen);
            }
        }
        else
        {
